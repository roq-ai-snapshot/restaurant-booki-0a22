  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine, where you can effortlessly reserve your table and where restaurant staff manage reservations and menus with ease."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine, where you can effortlessly reserve your table and where restaurant staff manage reservations and menus with ease.`}
            </Text>
            <Box
